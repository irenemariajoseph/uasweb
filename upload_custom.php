        ...
        <center>
            <section id="login" style="margin-top: 100px; margin-bottom: 150px" class="contact">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row mt-5">
                        <h2><b>SUBMIT YOUR CUSTOM DESIGN</b></h2>
                        <h5>Please add notes for more details of how many prints in one page</h5>


                        <div class="col-lg-12 mt-5 mt-lg-0" style="align-items: center;">
                            <form action="upload_cust_proses.php" method="post" enctype="multipart/form-data" style="width: 30%">
                                ...
                                <div class="form-group mt-3">
                                    <input class="input textPass" type="file" name="foto_custom" placeholder="Upload Your Photo" required><br />

                                </div>
                                <div class="form-group mt-3">
                                    <textarea class="input textPass" type="text" name="note_custom" placeholder="Add Notes"></textarea><br />
                                ...
                                <br>
                                <div class="text-center"><button class="button login" type="submit">Upload Custom Design</button></div>
                            </form>
